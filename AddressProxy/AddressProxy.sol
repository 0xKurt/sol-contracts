 ...
 * @notice Stores a contract name and the address of a contract and can return the contract address by name.
...
contract AddressProxy {
     ...
     */
    event contractAddressModified(string eventNype, string contractName, address contractAddress);
